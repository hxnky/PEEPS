		...
		<nav>
			<ul class="icon">
				...
				<li class="right"><a id="Home" href="#"><img
						...
						src="/icon/navi/008-notification.png"></a> <a id="Chat"
					href="#"><img src="/icon/navi/050-wechat.png"></a> <a
					id="MyPage" href="#"><img src="/icon/navi/010-user.png"></a>
				</li>
