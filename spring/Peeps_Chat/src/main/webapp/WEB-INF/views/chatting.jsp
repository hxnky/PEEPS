...
<style>
    ...
    #chat .me .triangle {
        border-color: transparent transparent #F2D665 transparent;
        margin-left: 375px;
    }
    ...
    .button:hover {
        ...
        box-shadow: 0px 15px 20px #B485FF;
        color: #fff;
        transform: scale(1.1);
    }
    ...
    <div id="nav">
        ...
        <nav>
            <ul class="icon">
                ...
                <li class="left">
                    <span><input type="search" placeholder="서아언니 메롱">
                        <button>
                ...
                <li class="center">
                    <a id="Logo"><img src="/hyo0/icon/Logo.png"></a>
                </li>

                <li class="right">
                    <a id="Home" href="#"><img src="/hyo0/icon/navi/023-home.png"></a>
                    <a id="Content" href="#"><img src="/hyo0/icon/navi/Content.png"></a>
                    <a id="Alarm" href="#"><img src="/hyo0/icon/navi/008-notification.png"></a>
                    <a id="Chat" href="#"><img src="/hyo0/icon/navi/050-wechat.png"></a>
                    <a id="MyPage" href="#"><img src="/hyo0/icon/navi/010-user.png"></a>
                </li>
        ...
        <aside>
            <header>
                <li class="aside_search">
                    <span><input type="search" placeholder="색깔 어떻게 바꾸는 거야.....">
                        <button class="gray">
                            <a href="#"><img src="/hyo0/icon/navi/search.png"></a>
                        </button></span>
                </li>
