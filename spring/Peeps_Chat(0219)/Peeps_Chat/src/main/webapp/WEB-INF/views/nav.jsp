			...
			<ul class="icon">
				...
				<li class="right">
					...
					id="Content" href="#"><img
						...
						<li><img
						src="<c:url value='/icon/navi/008-notification.png' />">
						<c:url value="/test/test" var="alarmList" /><a
					id="Alarm" href="${alarmList}">${alarmList}</a><li>
						...
						<a
					id="Chat" href="#"><img
						src="<c:url value='/icon/navi/050-wechat.png'/>"></a><li>
