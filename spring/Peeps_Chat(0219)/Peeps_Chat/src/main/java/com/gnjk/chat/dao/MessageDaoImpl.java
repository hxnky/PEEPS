...
import com.gnjk.chat.domain.Message;
  ...
  @Repository public class MessageDaoImpl implements MessageDao {
  
  @Inject private SqlSession session; private static String namespace =
  "com.gnjk.dao.mapper.mybatisMessageDao";
