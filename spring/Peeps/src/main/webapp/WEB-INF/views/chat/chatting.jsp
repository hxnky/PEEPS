...
<script>
   sock = new SockJS("http://54.180.153.91:8080/chat/chat");
   ...
   $(document).ready(function() {
      ...
      weatherAPI();
      $.ajax({
         url : "http://54.180.153.91:8080/chat/room/select",
         type : "GET",
         dataType : "json",
      ...
      $.ajax({
         url : "http://54.180.153.91:8080/chat/mes/select",
         type : "GET",
         dataType : "json",
         success : function(data) {
            printMes(data);
...
<script>
   ...
   function weatherAPI() {
      ...
      $
            .ajax({
               url : "http://54.180.153.91:8080/chat/chattingData",
               type : "GET",
