   ...
   <div id="nav">
      <nav>
         <ul class="icon">
            ...
            <li class="center"><a id="Logo"><img src="<c:url value='/chat/icon/navi/Logo.png' />"></a></li>

            <li class="right"><a id="Home" href="#"><img src="<c:url value='/chat/icon/navi/023-home.png' />"></a> 
	    	<a id="Content" href="#"><img src="<c:url value='/chat/icon/navi/Content.png' />"></a> 
	   	    <a id="Alarm" href="#none"> <img onclick="modal('my_modal')" src="<c:url value='/chat/icon/navi/008-notification.png' />"></a>
            <a id="Chat" href=${pageContext.request.contextPath}/user/chatting> <img src="<c:url value='/chat/icon/navi/050-wechat.png'/>"> </a> 
