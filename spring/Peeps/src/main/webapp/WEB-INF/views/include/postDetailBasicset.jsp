						...
						success: function(data){
							...
							$.each(data, function(index, item){
								...
								if(item.loginType == "email"){
									var html = '<img class="postuserphoto" src="https://peepsmember.s3.ap-northeast-2.amazonaws.com/peeps/profile'+item.m_photo+'">';
							...
							if(mbr.m_idx == cmt.member_idx){
								...
								if(cmt.member_idx == sessionMidx){
									if(mbr.loginType == 'email'){
										$('.comment').append("<div class='cmt' id='"+cmt.cmt_idx+"'><img class='postuserphoto' src= 'https://peepsmember.s3.ap-northeast-2.amazonaws.com/peeps/profile"+mbr.m_photo+"'> <span class='id'>"+mbr.id+"</span> <input type='text' id='load_cmt' value='"+cmt.cmt_content+"'><button id='cmt_re' type='submit'>답글</button> <button id='cmt_edit' type='submit'>수정</button>  <button id='cmt_del' type='submit'>삭제</button><br><input type='hidden' id='replytext'></div>");
									}else{
										$('.comment').append("<div class='cmt' id='"+cmt.cmt_idx+"'><img class='postuserphoto' src= '<c:url value='"+mbr.m_photo+"'/>'> <span class='id'>"+mbr.id+"</span> <input type='text' id='load_cmt' value='"+cmt.cmt_content+"'><button id='cmt_re' type='submit'>답글</button> <button id='cmt_edit' type='submit'>수정</button>  <button id='cmt_del' type='submit'>삭제</button><br><input type='hidden' id='replytext'></div>");
									}
								} else {
									if(mbr.loginType == 'email'){
										$('.comment').append("<div class='cmt' id='"+cmt.cmt_idx+"'><img class='postuserphoto' src= 'https://peepsmember.s3.ap-northeast-2.amazonaws.com/peeps/profile"+mbr.m_photo+"'> <span class='id'>"+mbr.id+"</span> <input type='text' id='load_cmt' value='"+cmt.cmt_content+"'><button id='cmt_re' type='submit'>답글</button> <input id='cmt_edit' type='hidden'><input id='cmt_del' type='hidden'></div>");
									}else{
										$('.comment').append("<div class='cmt' id='"+cmt.cmt_idx+"'><img class='postuserphoto' src= '<c:url value='"+mbr.m_photo+"'/>'> <span class='id'>"+mbr.id+"</span> <input type='text' id='load_cmt' value='"+cmt.cmt_content+"'><button id='cmt_re' type='submit'>답글</button> <input id='cmt_edit' type='hidden'> <input id='cmt_del' type='hidden'></div>");
									}
								}
										...
										success: function(data){
											$.each(data, function(index, mbr){
												...
												if(mbr.m_idx == reply.member_idx){
													if(mbr.loginType== 'email'){
														$('#'+reply.comment_idx).append("<div class='reply' name='"+reply.re_idx+"'><img class='postuserphoto' src= 'https://peepsmember.s3.ap-northeast-2.amazonaws.com/peeps/profile"+mbr.m_photo+"'> <span class='id'> "+mbr.id+" </span> <input type='text' id='load_re' value='"+reply.re_content+"'><button id='re_edit' type='submit'>수정</button>  <button id='re_del' type='submit'>삭제</button></div>");
													}else{
														$('#'+reply.comment_idx).append("<div class='reply' name='"+reply.re_idx+"'><img class='postuserphoto' src= '<c:url value='"+mbr.m_photo+"'/>'> <span class='id'> "+mbr.id+" </span> <input type='text' id='load_re' value='"+reply.re_content+"'><button id='re_edit' type='submit'>수정</button>  <button id='re_del' type='submit'>삭제</button></div>");
													}
												}
									...
									$.ajax({ 
										...
										success: function(data){
											$.each(data, function(index, mbr){
												...
												if(mbr.m_idx == reply.member_idx){
													if(mbr.loginType== 'email'){
														$('#'+reply.comment_idx).append("<div class='reply' name='"+reply.re_idx+"'><img class='postuserphoto' src= 'https://peepsmember.s3.ap-northeast-2.amazonaws.com/peeps/profile"+mbr.m_photo+"'> <span class='id'> "+mbr.id+"</span> <input type='text' id='load_re' value='"+reply.re_content+"'></div>");
													}else{
														$('#'+reply.comment_idx).append("<div class='reply' name='"+reply.re_idx+"'><img class='postuserphoto' src= '<c:url value='"+mbr.m_photo+"'/>'> <span class='id'> "+mbr.id+"</span> <input type='text' id='load_re' value='"+reply.re_content+"'></div>");
													}
												}
