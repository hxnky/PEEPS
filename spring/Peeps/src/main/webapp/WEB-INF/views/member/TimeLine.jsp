										...
										if(post.member_idx == user){
											...
											$.ajax({
												...
												success : function(data){
													...
													$('#'+post.p_idx).append("<div class='post'><div id='post_title' onclick='GoPost("+post.p_idx+")'>"+post.p_title+"</div><div id='post_img'><img src='http://52.79.234.178:8080/post/resources/fileupload/postfile/"+post.p_thumbnail+"' class='img-responsive' alt='Image' onclick='GoPost("+post.p_idx+")'></div><button id='heart'><img src='<c:url value='/resources/images/icon/navi/002-like.png'/>'></button><hr></div>");
