...
public class GuestbookController {
	...
	public String getguestbookForm() {
		...
		return "/menu/guestbookForm2";

	}
	  @PostMapping(value = "/guestbook/insert")
	  @ResponseBody
	  public String guestbookInsert(@ModelAttribute("insertdata") GuestbookRequest
	  gRequest, HttpServletRequest request){
		  
         System.out.println(" 방명록작성 완료 ");
...
//	  return "/menu/guestbookForm"; }
	...
	/* 수정 */
	@RequestMapping(value = "/guestbook/edit", method = RequestMethod.GET)
	public String editForm(@RequestParam("gidx") int gidx, Model model) {
	...
	public String editGuestbook(GuestbookEditRequest editRequest, HttpServletRequest request, Model model) {
