 ...
 * 
 * import com.gnjk.peeps.guestbook.domain.GuestbookListView; import
 * com.gnjk.peeps.guestbook.service.GuestbookListService;
 * 
 * @Controller public class GuestbookListController {
 * 
 ...
 * model.addAttribute("listView",listService.getListView(page)); return
 * "/menu/list"; } }
 * 
 */