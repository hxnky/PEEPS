...
public class S3Util {
	private String accessKey = "AKIAI2D3VQCIJIAZF2KQ"; // 엑세스 키
	private String secretKey = "q8fsxTWNqIs2QcONZvi/vgRwKStl5F9ifCPqkn2X"; // 보안 엑세스 키
	...
	public String getFileURL(String bucketName, String fileName) {
		...
		String imgName = (fileName).replace(File.separatorChar, '/');
		System.out.println("바뀐 파일명 : " + imgName);
